...
public class MHIFFRunner {
	...
	public static void run(int runNumb) throws FileNotFoundException 
	{
		...
		for (MHIFFFitnessType action : MHIFFFitnessType.values()) {
		...
		RLFitnessEvaluator fitnessEvaluator = new MHIFFFitnessEvaluator(MHIFFFitnessType.HIFF.toString());
		...
		PrintWriter pwEA = new PrintWriter("MHIFF_" + populationSize + "_" + eliteCount + "_" + "target_value" + "_MS1_MIND_" + runNumb);
